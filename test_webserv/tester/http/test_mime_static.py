...
# These directories/files live under your webroot (e.g. "test_webserv/tester/data") so that
# GET /static/style.css maps to "test_webserv/tester/data/static/style.css".
TEST_ROOT = "test_webserv/tester/data"
