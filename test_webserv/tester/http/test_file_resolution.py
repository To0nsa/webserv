# test_webserv/tester/http/test_file_resolution.py
...
def setup_test_files():
    base_dir = "test_webserv/tester/data/dir"
...
def cleanup_test_files():
    ...
    for f in ["style.CsS", "index.html.bak"]:
        try:
            ...
            pass
    shutil.rmtree("test_webserv/tester/data/dir", ignore_errors=True)
...
def run_tests():
    ...
    # 1) Serve static under /dir/ → test_webserv/tester/data/dir/file.txt
