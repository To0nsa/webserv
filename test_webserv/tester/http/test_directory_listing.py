...
DIR_PATH      = "test_webserv/tester/data/dir"        # for /dir/
FORBIDDEN_DIR = "test_webserv/tester/data/secret"     # for /forbidden/
...
def cleanup_test_files():
    ...
    # Remove test_webserv/tester/data/secret/index.html if we created it
...
def setup_test_files():
    """
    Ensure that:
      - test_webserv/tester/data/dir exists with file.txt and file.unknown
      - test_webserv/tester/data/secret/index.html exists with minimal content
    """
    # Prepare /dir/
...
def test_forbidden_autoindex_off():
    """
    /forbidden has autoindex off and index.html under test_webserv/tester/data/secret/:
...
def test_index_file_precedence():
    ...
    Location /with_index/ has both autoindex ON and index index.html.
     - If index.html exists in test_webserv/tester/data/with_index, GET /with_index/ → 200 serving index.html
     - Once index.html is removed, GET /with_index/ → 200 with a directory listing that contains file1.txt
    """
    base = "test_webserv/tester/data/with_index"
