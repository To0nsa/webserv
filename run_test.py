...
def main():
    ...
    test_stress_cgi	   = os.path.join(root, "test", "http", "stress_cgi.py")
    ...
    test_slash_behavior = os.path.join(root, "test", "http", "test_slash_behavior.py")
    test_connection = os.path.join(root, "test", "http", "test_connection.py")
    test_cgi       = os.path.join(root, "test", "http", "test_cgi.py")
    # test_ultra_stress     = os.path.join(root, "test", "http", "ultra_stress_test.py")

    run (["python3", test_cgi], "test_cgi.py")
    run(["python3", test_stress_cgi], "stress_cgi.py")
    run(["python3", test_connection], "test_connection.py")
    run(["python3", test_symlinks], "test_symlinks_forbidden.py")
    run(["python3", test_slash_behavior], "test_slash_behavior.py")
