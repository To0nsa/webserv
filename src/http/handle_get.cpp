...
/*   Updated: 2025/05/15 19:18:14 by irychkov         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
        ...
        if (S_ISREG(fileStat.st_mode)) {
            ...
            if (loc.isAutoindexEnabled()) {
                ...
                if (dir) {
                    ...
                    indexStream << "<html><body><h1> &nbsp;&nbsp; Index of " << request.getPath()
                                << "</h1>";
                    indexStream << "<table><tr><th>Name</th><th>Last Modified (UTC)</th><th>Size "
                                   "(bytes)</th></tr>";
                    ...
                    auto renderEntry = [&](const std::string& name) {
                        ...
                        indexStream << "<tr>";
                        indexStream << "<td style='min-width: 20ch; padding-right: 30px;'><a href='"
                                    << href << "'>" << displayName << "</a></td>";
                    ...
                    // Render ".." if present
                    if (!dirs.empty() && dirs[0] == "..") {
                        indexStream << "<tr><td colspan='3'><a href='" << baseUri
                                    << "../'>../</a></td></tr>";
